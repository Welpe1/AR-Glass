...
class Yolov5RKNN:
    def __init__(self,
                 model_path:str=f"{os.path.dirname(os.path.abspath(__file__))}/model/yolov5_rk3566_int8.rknn",
                 target:str='rk3566'):
    ...
    # def infer(self,image):
    #     img=self.co_helper.letter_box(im=image.copy(),new_shape=(IMG_SIZE[1],IMG_SIZE[0]),pad_color=(0,0,0))
...
if __name__ == '__main__':
    ...
    while True:
        ...
        if not ret:
            ...
            break
        result_frame,classes,_= yolo.infer(frame)
        print(classes)
